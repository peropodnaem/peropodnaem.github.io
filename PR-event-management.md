...
metadescription: "Перо под наем е ваш сигурен партньор в изграждането на PR кампанията на вашия бранд или фирма и организирането на всякакви събития благодарение на дългогодишния опит в сферата."
style: |
    .page-background {
